...
`Day_timer` är en SvelteKit-port av [`the_timer`](https://github.com/ximonse/the_timer) — en visuell timer för lärare. Målet var en **pixel-perfekt, funktionsidentisk kopia** av the_timer, men appen har nu vuxit till en dagplanerare med `Nu`, `Planera`, agenda, kalender, mallar och live-delning.
...
- ✅ **Agenda-panel** (höger kolumn) — tidslinje med drag-gränser per block, separat flytthandtag och kompakt kalender för dagval
...
- ✅ **Hjälpläge** — global `Visa hjälp` plus `Alt+i`, med lokala `i`-knappar som kan visa eller gömma enskilda hjälptexter
- ✅ **Bibliotek** — mallar kan laddas i rätt sammanhang och läggas på vald dag i agendan
- ✅ **Dagtext** — planera dag för dag med kalenderstyrd textyta i agendan
...
- ✅ Dagtext-editorn blev kalenderstyrd och går att skriva i normalt igen
- ✅ `Alt+i` kopplades till global hjälp
- ✅ Blockflyttning i agendan fick separat flytthandtag
